...
# Inicializamos la captura de video desde un archivo o una cámara
video_capture = cv2.VideoCapture('TecVideo.mp4')  
...
while True:
    ...
    for contorno in contornos:
        if cv2.contourArea(contorno) > 9000:  # Filtramos contornos pequeños
